...
_CRIU_PRE_DUMP_MODE = _descriptor.EnumDescriptor(
  name='criu_pre_dump_mode',
  full_name='criu_pre_dump_mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='SPLICE', index=0, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VM_READ', index=1, number=2,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_CRIU_PRE_DUMP_MODE)
...
_CRIU_OPTS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cgroup_yard', full_name='criu_opts.cgroup_yard', index=58,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pre_dump_mode', full_name='criu_opts.pre_dump_mode', index=59,
...
_CRIU_OPTS.fields_by_name['pre_dump_mode'].enum_type = _CRIU_PRE_DUMP_MODE
...
DESCRIPTOR.enum_types_by_name['criu_pre_dump_mode'] = _CRIU_PRE_DUMP_MODE
